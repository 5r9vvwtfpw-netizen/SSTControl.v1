      ...
      return (
        <div style={{ padding: 32, fontFamily: "sans-serif" }}>
          ...
          <p style={{ color: "#6b7280", marginBottom: 16 }}>
            Por favor recargue la página. Si el error persiste, contáctenos.
          </p>
          <pre style={{ background: "#f3f4f6", padding: 16, borderRadius: 8, fontSize: 12, overflowX: "auto", color: "#374151" }}>
          ...
          <button
            ...
            style={{ marginTop: 16, padding: "8px 16px", background: "#16a34a", color: "#fff", border: "none", borderRadius: 6, cursor: "pointer" }}
          >
            Recargar página
          </button>
        </div>
