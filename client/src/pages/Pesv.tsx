...
export default function Pesv() {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      {/* 
        NOTA: Enlaces a módulos ocultos - Los módulos PESV ahora se acceden desde los pasos de evaluación.
        Siguiendo el patrón de los paneles SST (DashboardHacer, DashboardVerificar, DashboardActuar),
        este panel solo muestra estadísticas y métricas.
        El código de los enlaces se conserva comentado para referencia futura.
      */}
