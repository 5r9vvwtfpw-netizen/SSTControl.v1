...
const MODULE_LIST = [
  ...
  { route: "/portal-licenciado#panel", name: "LSO - Panel Principal", group: "Portal LSO" },
  { route: "/portal-licenciado#empresas", name: "LSO - Empresas Asignadas", group: "Portal LSO" },
  { route: "/portal-licenciado#documentos", name: "LSO - Documentos", group: "Portal LSO" },
  { route: "/portal-licenciado#pesv", name: "LSO - PESV", group: "Portal LSO" },
  { route: "/portal-licenciado#mi-licencia", name: "LSO - Mi Licencia", group: "Portal LSO" },
  { route: "/portal-licenciado#mensajes", name: "LSO - Mensajes", group: "Portal LSO" },
  { route: "/portal-empleados#contrato", name: "Empleado - Mi Contrato", group: "Portal Empleados" },
  { route: "/portal-empleados#perfil", name: "Empleado - Mi Perfil", group: "Portal Empleados" },
  { route: "/portal-empleados#mi-foto", name: "Empleado - Mi Foto de Carnet", group: "Portal Empleados" },
  { route: "/portal-empleados#cambiar-password", name: "Empleado - Cambiar Contraseña", group: "Portal Empleados" },
  { route: "/portal-empleados#documentos-asignados", name: "Empleado - Documentos Asignados", group: "Portal Empleados" },
  { route: "/portal-empleados#cursos-virtuales", name: "Empleado - Cursos Virtuales", group: "Portal Empleados" },
  { route: "/portal-empleados#capacitaciones", name: "Empleado - Capacitaciones", group: "Portal Empleados" },
  { route: "/portal-empleados#mis-inducciones", name: "Empleado - Mis Inducciones", group: "Portal Empleados" },
  { route: "/portal-empleados#inducciones-virtuales", name: "Empleado - Inducciones Virtuales", group: "Portal Empleados" },
  { route: "/portal-empleados#comunicaciones", name: "Empleado - Comunicaciones SST", group: "Portal Empleados" },
  { route: "/portal-empleados#reportar", name: "Empleado - Reportar Incidente", group: "Portal Empleados" },
  { route: "/portal-empleados#mis-reportes", name: "Empleado - Mis Reportes", group: "Portal Empleados" },
  { route: "/portal-empleados#elecciones-copasst", name: "Empleado - Elecciones COPASST", group: "Portal Empleados" },
  { route: "/portal-empleados#elecciones-convivencia", name: "Empleado - Elecciones Convivencia", group: "Portal Empleados" },
  { route: "/portal-empleados#mis-examenes-medicos", name: "Empleado - Mis Exámenes Médicos", group: "Portal Empleados" },
  { route: "/portal-empleados#mis-audiometrias", name: "Empleado - Mis Audiometrías", group: "Portal Empleados" },
  { route: "/portal-empleados#comite-pesv", name: "Empleado - Comité de Seguridad Vial", group: "Portal Empleados" },
  { route: "/portal-empleados#capacitaciones-pesv", name: "Empleado - Capacitaciones PESV", group: "Portal Empleados" },
