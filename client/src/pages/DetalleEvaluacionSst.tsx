    ...
    <div className="space-y-6">
      ...
      <Dialog open={respuestaDialogOpen} onOpenChange={setRespuestaDialogOpen}>
        <DialogContent className="sm:max-w-[600px] max-h-[85vh] overflow-y-auto">
          ...
          {/* Estándar 6.1.2 - Auditoría anual */}
          ...
          {/* Estándar 7.1.3 - Acciones de mejora con base en investigaciones */}
          {selectedEstandar?.numeroEstandar === "7.1.3" && (
            <div className="mb-4">
              <Estandar713VerificacionAccionesInvestigaciones 
                isVisible={true}
                evaluationId={id}
              />
            </div>
