...
// Comprehensive work areas based on Colombian CIIU economic sectors
const COMMON_WORK_AREAS = [
  ...
  "Porqueriza",
  "Sala de Ordeño",
  "Cuarto Frío Agrícola",
  "Área de Fumigación",
  "Bodega de Agroquímicos",
  "Vivero",
  "Área de Empaque Agrícola",
  // === SECTOR MINERÍA Y CANTERAS (CIIU B) ===
  "Frente de Explotación",
  "Túnel / Socavón",
  "Planta de Beneficio Minero",
  "Área de Trituración",
  "Área de Voladura",
  "Polvorín",
  "Patio de Acopio Minero",
  "Laboratorio de Análisis Minero",
  // === SECTOR MANUFACTURA E INDUSTRIA (CIIU C) ===
  "Producción",
  "Manufactura",
  "Línea de Ensamble",
  "Área de Soldadura",
  ...
  "Área de Galvanizado",
  "Área de Cromado / Recubrimientos",
  "Planta de Alimentos",
  "Área de Faenado",
  ...
  "Planta Textil",
  "Área de Confección",
  "Área de Tintorería Industrial",
  "Carpintería / Ebanistería",
  "Área de Impresión",
  // === SECTOR ELECTRICIDAD, GAS Y AGUA (CIIU D-E) ===
  ...
  "Estación de Bombeo",
  "Planta de Residuos",
  // === SECTOR CONSTRUCCIÓN (CIIU F) ===
  "Obra Civil",
  "Frente de Obra",
  "Área de Excavación",
  "Área de Encofrado",
  "Área de Fundición de Concreto",
  "Taller de Obra",
  "Campamento de Obra",
  "Área de Corte y Figurado",
  // === SECTOR COMERCIO (CIIU G) ===
  "Piso de Ventas",
  "Caja / Punto de Pago",
  "Vitrina / Exhibición",
  "Bodega Comercial",
  "Cuarto Frío Comercial",
  "Área de Recibo de Mercancía",
  "Centro de Distribución",
  // === SECTOR TRANSPORTE Y ALMACENAMIENTO (CIIU H) ===
  "Almacén",
  "Bodega",
  ...
  "Taller Automotriz",
  "Zona de Lavado",
  // === SECTOR ALOJAMIENTO Y RESTAURANTES (CIIU I) ===
  "Cocina Industrial",
  "Área de Preparación de Alimentos",
  "Cuarto Frío de Cocina",
  "Lavado de Vajilla",
  "Salón / Área de Atención",
  "Habitaciones",
  "Lavandería",
  "Área de Eventos",
  // === SECTOR INFORMACIÓN Y COMUNICACIONES (CIIU J) ===
  "Centro de Datos / Data Center",
  "Sala de Servidores",
  "Call Center",
  "Estudio de Grabación",
  "Sala de Edición",
  "Área de Desarrollo / TI",
  // === SECTOR FINANCIERO (CIIU K) ===
  ...
  "Taller Educativo",
  // === SECTOR SERVICIOS PROFESIONALES (CIIU M-N) ===
