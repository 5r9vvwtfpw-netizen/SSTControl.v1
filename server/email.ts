          ...
          <tr>
            <td style="padding: 36px 30px 24px 30px;">
              ...
              <p style="margin: 0 0 24px 0; color: #374151; font-size: 14px;">
                <strong>${data.companyName}</strong> te da acceso al Portal de Empleados:
              </p>
              ...
              <div style="text-align: center; margin: 0 0 20px 0;">
                <a href="${data.loginUrl}" style="display: inline-block; background-color: #1d4ed8; color: #ffffff; text-decoration: none; padding: 13px 32px; border-radius: 8px; font-size: 15px; font-weight: 700;">
                  Descargar App
                </a>
              </div>
