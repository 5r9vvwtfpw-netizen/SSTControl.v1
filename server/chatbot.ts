...
- **H04 - Vehículos Seguros** → botón abre '/pesv/evaluacion/:id/vehiculos' (también accesible desde PESV → Vehículos en el menú lateral → '/pesv/vehiculos') — Inventario de vehículos: placa, marca, modelo, año, tipo, SOAT (vencimiento), revisión tecnicomecánica (vencimiento), tarjeta de operación.
  **CÓMO VER LAS FECHAS DE SOAT Y TECNICOMECÁNICA SIN ABRIR CADA VEHÍCULO:** La tabla principal ya muestra dos columnas de vencimiento con badge de color para cada vehículo: **"Venc. SOAT"** y **"Venc. Tecnicomecánica"**. Los colores significan: 🔴 rojo = documento vencido, 🟡 amarillo = vence en los próximos 30 días, 🟢 verde = vigente, "Sin registro" = no se ha ingresado la fecha. No es necesario abrir cada vehículo individualmente — toda la flota se ve de un vistazo en la tabla.
  **CÓMO GENERAR EL INFORME PDF DE FLOTA CON FECHAS DE SOAT Y RTM:** En la pantalla de vehículos (H04) hay un botón **"Descargar informe PDF"** en la parte superior derecha. Al hacer clic descarga un PDF con dos tablas: (1) Tabla de parque automotor (placa, marca, modelo, tipo, estado) y (2) Tabla de **"Vencimientos de Documentos"** que muestra para cada vehículo: Placa | Venc. SOAT | Estado SOAT | Venc. Rev. Técnica | Estado RTM. Las filas marcadas con "⚠ Vencido" indican documentos ya vencidos. Este PDF se puede adjuntar a correos, imprimir o presentar en auditorías.
  **ALERTAS AUTOMÁTICAS DE VENCIMIENTO:** El sistema envía automáticamente una notificación interna (campanita 🔔) y un correo electrónico al administrador o responsable SST de la empresa **todos los días a las 8:00 AM** cuando detecta: SOAT vencido o próximo a vencer (≤30 días), Revisión Tecnicomecánica vencida o próxima a vencer, Licencias de conducción de conductores vencidas o próximas a vencer, Exámenes médicos de conductores vencidos o próximos a vencer. La alerta no se repite si ya se envió en los últimos 7 días. Para que las alertas funcionen correctamente, cada vehículo debe tener registrada la fecha de vencimiento del SOAT (campo "Vencimiento SOAT") y de la RTM (campo "Vencimiento Tecnicomecánica") en su ficha.
