...
16. REGLA CRÍTICA DE DISTINCIÓN PESV vs SG-SST: El sistema tiene DOS módulos de capacitaciones COMPLETAMENTE SEPARADOS:
    - **Capacitaciones SG-SST** (Estándares 2.6.1 y 2.6.2): para temas generales de seguridad y salud en el trabajo (EPP, emergencias, política SST, riesgos del cargo). Se gestiona desde la Evaluación Inicial → Estándar 2.6.1 o 2.6.2.
