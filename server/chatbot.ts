...
- **¿Cómo diligenciar el paso P05 - Objetivos e Indicadores?** El paso P05 gestiona los Indicadores de Desempeño de Seguridad (SPI) según ISO 39001 Cláusula 9.1. Antes de usar el botón **"Auto-calcular"** de cada indicador, es obligatorio tener diligenciados los siguientes módulos según el tipo de indicador que se quiere calcular: (1) **H04 - Vehículos Seguros** + **V02 - Registro y Análisis de Siniestros** — para los indicadores de tasa de siniestralidad y mortalidad vial; (2) **H01 - Factor Humano / Conductores** + **H03 - Documentación y Comparendos** — para el índice de infracciones de tránsito por cada 100 conductores; (3) **H06 - Inspecciones Preoperacionales** (/pesv/evaluacion/:id/inspecciones-vehiculos) + **H04 - Vehículos Seguros** — para el porcentaje de cumplimiento de inspecciones; (4) **H02 - Capacitación en Seguridad Vial** + **H01 - Factor Humano / Conductores** — para la cobertura de capacitación en seguridad vial; (5) **H05 - Mantenimiento Vehicular** (/pesv/evaluacion/:id/mantenimiento) — para el cumplimiento del plan de mantenimiento; (6) **H01 - Factor Humano / Conductores** con los campos de vencimiento de licencia y examen médico diligenciados — para el porcentaje de conductores con documentos vigentes. Cómo usar: Evaluación PESV → paso P05 → "Ir al módulo" → clic en el indicador → clic **"Medición"** → en el diálogo aparece el botón **"Auto-calcular"** → el sistema consulta los módulos anteriores y completa el valor con una nota explicativa del cálculo. Los indicadores sin datos disponibles muestran un aviso ámbar para ingreso manual. Orden recomendado antes de P05: H04 → H01 → H03 → H02 → H05 → H06 → V02 → luego P05.

- **¿Cómo funciona el auto-cálculo del paso P05 - Objetivos e Indicadores?** P05 gestiona los Indicadores de Desempeño de Seguridad (SPI) según ISO 39001. Cada indicador tiene un botón **"Auto-calcular"** disponible dentro del diálogo de "Medición". El cálculo automático requiere los siguientes módulos según el tipo de indicador: tasa de siniestralidad → **V02 - Siniestros** + **H04 - Vehículos**; infracciones de tránsito → **H03 - Comparendos** + **H01 - Conductores**; inspecciones preoperacionales → **H06 - Inspecciones Preoperacionales** + **H04 - Vehículos**; cobertura de capacitación → **H02 - Capacitación en Seguridad Vial** + **H01 - Conductores**; mantenimiento vehicular → **H05 - Mantenimiento Vehicular**; vigencia de licencias → **H01 - Conductores** (con fechas de vencimiento diligenciadas). Los indicadores sin datos muestran un aviso ámbar para ingreso manual.

- **¿Cómo funciona el auto-cálculo del paso P06 - Factores de Desempeño SPF?** P06 gestiona los Factores de Desempeño de Seguridad (SPF) según ISO 39001:2012. El formulario tiene dos automatismos: (1) el desplegable **"Auto-completar desde catálogo ISO 39001"** que pre-llena nombre, descripción, categoría y unidad de medida del factor; (2) el botón **"Auto-calcular"** (ícono de varita) junto al campo "Valor Actual" que completa tanto Valor Base como Valor Actual con datos reales del sistema. Los mismos módulos que P05 alimentan P06: **H04, V02, H01, H03, H06, H02, H05**. Cuando el cálculo es exitoso aparece un panel verde con la explicación (ej: "2 siniestros / 1 vehículo × 100"). Si no hay datos aparece un panel ámbar indicando ingreso manual. Orden recomendado antes de P06: H04 → H01 → H03 → H02 → H05 → H06 → V02 → luego P03 → P05 → P06.
