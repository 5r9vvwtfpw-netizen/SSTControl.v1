...
- **P06 - Programas y Planes / Factores de Desempeño SPF** → botón abre '/pesv/evaluacion/:id/factores-desempeno' — **ESTE PASO LO GESTIONA EXCLUSIVAMENTE EL LICENCIADO EN SST (LSO).** La empresa NO lo diligencia. Gestión de los Factores de Desempeño de Seguridad (SPF) según ISO 39001:2012 Cláusula 6.3. El LSO registra los factores seleccionando del catálogo de 16 factores predefinidos; el sistema completa automáticamente todos los campos (Nombre, Descripción, Categoría, Unidad de Medida, Meta Anual, Valor Base y Valor Actual) consultando los datos reales del sistema. Si un usuario de empresa pregunta cómo diligenciar P06, se le debe indicar que ese paso lo realiza su profesional LSO asignado y que la empresa verá la información una vez el LSO la complete.
