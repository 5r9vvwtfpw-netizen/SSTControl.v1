...
- **P06 - Programas y Planes / Factores de Desempeño SPF** → botón abre '/pesv/evaluacion/:id/factores-desempeno' — Gestión de los Factores de Desempeño de Seguridad (SPF) según ISO 39001:2012. Incluye catálogo de 16 factores predefinidos y el botón "Auto-calcular" para completar Valor Base y Valor Actual desde datos reales.
  **Requisitos previos para el auto-cálculo de P06:** El botón "Auto-calcular" en el formulario de cada factor consulta los mismos módulos que P05:
  - **H04 - Vehículos Seguros** + **V02 - Siniestros**: factores de resultado final y exposición al riesgo (tasa de mortalidad, siniestros fatales).
  - **H01 - Conductores** + **H03 - Comparendos**: factores de resultado intermedio (índice de infracciones, comportamiento vial).
  - **H06 - Inspecciones Preoperacionales**: factores de intervención sobre vehículos.
  - **H02 - Capacitación en Seguridad Vial**: cobertura de formación en conductores.
  - **H05 - Mantenimiento Vehicular**: cumplimiento del plan de mantenimiento de flota.
  Cómo usar el botón "Auto-calcular" en P06: (1) Evaluación PESV → paso P06 → "Ir al módulo". (2) Clic en "Agregar Factor" o editar uno existente. (3) Seleccionar un factor del desplegable "Auto-completar desde catálogo ISO 39001" — esto pre-llena nombre, descripción, categoría y unidad de medida. (4) Clic en el botón "Auto-calcular" (ícono de varita) junto al campo "Valor Actual". (5) El sistema completa tanto "Valor Base" como "Valor Actual" con datos reales y muestra un panel verde con la explicación del cálculo (ej: "2 siniestros / 1 vehículo × 100"). (6) Si el módulo fuente no tiene datos, aparece un panel ámbar indicando ingreso manual. Orden recomendado antes de P06: H04 → H01 → H03 → H02 → H05 → H06 → V02 → luego P03 → P05 → P06.
...
- **¿Cómo diligenciar el paso P05 - Objetivos e Indicadores?** El paso P05 gestiona los Indicadores de Desempeño de Seguridad (SPI) según ISO 39001 Cláusula 9.1. Antes de usar el auto-cálculo, es indispensable tener registrada información en los módulos que alimentan cada tipo de indicador: (1) **H04 - Vehículos Seguros** + **V02 - Registro y Análisis de Siniestros** → para calcular la tasa de siniestralidad y mortalidad vial; (2) **H01 - Factor Humano / Conductores** + **H03 - Documentación y Comparendos** → para calcular el índice de infracciones de tránsito por cada 100 conductores; (3) **H04 - Vehículos Seguros** + **H06 - Inspecciones Preoperacionales** → para calcular el porcentaje de cumplimiento de inspecciones; (4) **H01 - Factor Humano / Conductores** + **H02 - Capacitación en Seguridad Vial** → para calcular la cobertura de formación en conductores; (5) **H05 - Mantenimiento Vehicular** → para calcular el porcentaje de cumplimiento del plan de mantenimiento; (6) **H01 - Factor Humano / Conductores** (con campos de vencimiento de licencia y examen médico diligenciados) → para calcular el porcentaje de conductores con documentos vigentes. Cómo usar: Evaluación PESV → paso P05 → "Ir al módulo" → seleccionar el indicador → clic "Medición" → en el diálogo aparece el botón **"Auto-calcular"** → el sistema calcula y completa el valor con una nota explicativa del cálculo. Los indicadores cuyos módulos fuente no tienen datos muestran un aviso ámbar para ingreso manual.

- **¿Qué módulos debo tener llenos antes de usar P05?** Antes de ejecutar el auto-cálculo de P05, debe tener registrada información en: **H04 - Vehículos Seguros**, **H01 - Factor Humano / Conductores**, **H03 - Documentación y Comparendos**, **H02 - Capacitación en Seguridad Vial**, **H05 - Mantenimiento Vehicular**, **H06 - Inspecciones Preoperacionales**, y **V02 - Registro y Análisis de Siniestros**. Sin estos datos el sistema no puede calcular los valores automáticamente y el botón indicará que no hay datos disponibles.

- **¿Cómo diligenciar el paso P06 - Factores de Desempeño SPF?** El paso P06 gestiona los Factores de Desempeño de Seguridad (SPF) según ISO 39001:2012. Al igual que P05, requiere tener previamente diligenciados los módulos base antes de usar el auto-cálculo. Los módulos necesarios son exactamente los mismos que P05: (1) **H04 - Vehículos Seguros** + **V02 - Siniestros** → factores de resultado final (tasa de mortalidad, siniestros fatales); (2) **H01 - Conductores** + **H03 - Comparendos** → factores de resultado intermedio (índice de infracciones, comportamiento vial); (3) **H06 - Inspecciones Preoperacionales** → factores de intervención sobre vehículos; (4) **H02 - Capacitación en Seguridad Vial** → cobertura de formación en conductores; (5) **H05 - Mantenimiento Vehicular** → cumplimiento del plan de mantenimiento de flota. Cómo usar el botón "Auto-calcular" en P06: (1) Evaluación PESV → paso P06 → "Ir al módulo"; (2) clic en "Agregar Factor" o editar uno existente; (3) seleccionar un factor del desplegable **"Auto-completar desde catálogo ISO 39001"** — esto pre-llena nombre, descripción, categoría y unidad de medida; (4) clic en el botón **"Auto-calcular"** (ícono de varita) junto al campo "Valor Actual"; (5) el sistema completa tanto "Valor Base" como "Valor Actual" con datos reales y muestra un panel verde con la explicación (ej: "2 siniestros / 1 vehículo × 100"); (6) si el módulo fuente no tiene datos, aparece un panel ámbar indicando ingreso manual. Orden recomendado antes de P06: H04 → H01 → H03 → H02 → H05 → H06 → V02 → luego P03 → P05 → P06.

- **¿Qué módulos debo tener llenos antes de usar P06?** Antes de ejecutar el auto-cálculo de P06, debe tener registrada información en los mismos módulos que P05: **H04 - Vehículos Seguros**, **H01 - Factor Humano / Conductores**, **H03 - Documentación y Comparendos**, **H02 - Capacitación en Seguridad Vial**, **H05 - Mantenimiento Vehicular**, **H06 - Inspecciones Preoperacionales**, y **V02 - Registro y Análisis de Siniestros**. Sin estos datos previos, el botón "Auto-calcular" indicará que no hay información disponible y los campos deberán llenarse manualmente.
