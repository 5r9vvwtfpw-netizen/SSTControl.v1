...
class AccountingIntegrationService {
  ...
  async sendInvoiceToAccounting(data: AccountingInvoiceData): Promise<AccountingResponse> {
    ...
    const payload = {
      source: 'sst-colombia',
      sourceInvoiceId: data.invoiceId,
      sourceInvoiceNumber: data.invoiceNumber,
      customer: {
      ...
      metadata: {
        ...
        ciiuCode: data.snapshotCiiuCode || null,
        numberOfWorkers: data.snapshotNumberOfWorkers || null,
        numberOfVehicles: data.snapshotNumberOfVehicles || null,
