...
export async function generatePropuestaComercialPdf(params: PropuestaParams = {}): Promise<Buffer> {
  ...
  const tagline        = params.tagline        || 'Plataforma completa SG-SST con Res. 0312/2019, PESV Supertransporte, Portal del Empleado, Soporte 24h, Asistente Virtual IA y Actualizaciones Normativas automaticas — todo incluido. Sin papeles, con trazabilidad total e informes PDF en menos de 5 minutos.';
