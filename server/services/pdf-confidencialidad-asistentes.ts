 ...
 * 13 cláusulas · Máximo rigor
 * Partes firmantes: EL PROVEEDOR (SST-Colombia) y EL ASISTENTE
 */
...
export interface ConfidencialidadAsistenteData {
  ...
  nombreConsultor?: string;      // Contexto — no firma
...
export async function generateConfidencialidadAsistentePdf(
  ...
  return new Promise((resolve, reject) => {
    ...
    doc.moveDown(0.5);
    doc.font("Helvetica-Bold").text("EL PROVEEDOR", { width: pw - MARGIN * 2, align: "center" });
    doc.font("Helvetica").text("SISTEMA AUTOMATIZADO DE GESTIÓN INTEGRAL S.A.S.", { width: pw - MARGIN * 2, align: "center" });
    doc.text("NIT 902.036.337-4", { width: pw - MARGIN * 2, align: "center" });
    doc.moveDown(0.5);
    ...
    para(`Consta por el presente documento el ACUERDO DE CONFIDENCIALIDAD Y NO CAPTACIÓN DE CLIENTES, celebrado en la ciudad de Medellín, Antioquia, el ${fechaAcuerdo}, entre: (i) SISTEMA AUTOMATIZADO DE GESTIÓN INTEGRAL S.A.S., sociedad colombiana identificada con NIT 902.036.337-4, inscrita en la Cámara de Comercio de Medellín para Antioquia, que actúa a través de su Representante Legal LUZ ADRIANA DIAZ CALLE, identificada con C.C. No. 52.223.631 (en adelante "EL PROVEEDOR"); y (ii) ${nombreAsistente}, identificado(a) con C.C. No. ${ccAsistente}, quien desempeñará funciones como ${cargoAsistente} en apoyo al Consultor Aliado ${nombreConsultor} (C.C./NIT ${idConsultor}) (en adelante "EL ASISTENTE").`);

    para(`EL PROVEEDOR es titular de la plataforma tecnológica denominada "SST Colombia" (en adelante "La Plataforma") y, en su calidad de licenciante del software, exige a toda persona que acceda operativamente a La Plataforma la suscripción del presente acuerdo, como condición previa e indispensable para la habilitación de sus credenciales de acceso.`);

    // ── CLÁUSULAS ─────────────────────────────────────────────────────────

    clauseTitle("PRIMERA", "Objeto");
    para(`El presente acuerdo tiene por objeto establecer las condiciones de confidencialidad, restricción de uso de información, no captación de clientes y uso aceptable de La Plataforma, bajo las cuales EL ASISTENTE accederá al sistema "SST Colombia" de propiedad de EL PROVEEDOR, para apoyar las actividades de consultoría en Seguridad y Salud en el Trabajo que el Consultor Aliado presta a sus propios clientes empresariales. EL ASISTENTE reconoce que su acceso es estrictamente instrumental y condicionado a la Alianza Principal que el Consultor mantiene con EL PROVEEDOR, y que no le confiere ningún derecho autónomo sobre La Plataforma ni sobre los clientes atendidos.`);
    ...
    bullet("Cliente del Consultor:", "Toda persona natural o jurídica cuya información esté gestionada en La Plataforma bajo la cuenta del Consultor Aliado, independientemente del período durante el cual EL ASISTENTE haya tenido acceso a dicha información.");
    ...
    bullet("", "Los Datos Sensibles de los trabajadores de los clientes del Consultor Aliado.");
    ...
    bullet("", "Si lo hace en nombre de un empleador, consultor, plataforma tecnológica o empresa diferente al Consultor Aliado.");
    ...
    para("La violación de esta cláusula activa automáticamente la cláusula penal establecida en la Cláusula Décima Segunda, sin perjuicio de las acciones civiles y penales a que haya lugar.");

    clauseTitle("SEXTA", "Prohibiciones Expresas de Manejo de Datos");
    para("En atención al carácter sensible de la información gestionada en La Plataforma, EL ASISTENTE tiene estrictamente prohibido:");
    ...
    bullet("b)", "Tomar capturas de pantalla, fotografías o cualquier registro visual de información personal de trabajadores o datos empresariales confidenciales, salvo autorización expresa y documentada.");
    bullet("c)", "Reenviar información confidencial o Datos Sensibles a cuentas de correo electrónico personales, servicios de mensajería instantánea, plataformas de almacenamiento en la nube no autorizadas o cualquier destinatario no autorizado.");
    bullet("d)", "Almacenar información de La Plataforma en dispositivos de almacenamiento externo (memorias USB, discos duros externos) sin autorización escrita previa.");
    bullet("e)", "Imprimir documentos con datos personales de trabajadores para uso distinto al expresamente autorizado para cada caso concreto.");
    bullet("f)", "Utilizar la información a la que acceda para finalidades distintas al apoyo de la labor consultiva del Consultor Aliado.");

    clauseTitle("SÉPTIMA", "Uso Aceptable del Sistema");
    para("EL ASISTENTE se compromete a hacer uso de La Plataforma exclusivamente para los fines laborales asignados, conforme a las siguientes condiciones:");
    bullet("", "Solo utilizará dispositivos autorizados y registrados ante EL PROVEEDOR para acceder a La Plataforma.");
    bullet("", "No accederá a La Plataforma fuera del horario laboral acordado, salvo autorización escrita previa para un caso específico.");
    bullet("", "No intentará acceder a funcionalidades o información no autorizadas, ni realizará pruebas de seguridad ni intentos de eludir los controles de acceso.");
    ...
    para("EL ASISTENTE está obligado a notificar de manera inmediata, y en ningún caso después de DOCE (12) HORAS de conocido el hecho, cualquier Incidente de Seguridad, incluyendo:");
    ...
    bullet("", "No ceder, transferir, vender ni compartir datos personales con terceros bajo ninguna circunstancia.");
    bullet("", "Adoptar las medidas técnicas y organizativas necesarias para evitar pérdida, acceso no autorizado, uso indebido o alteración de los datos personales.");
    para("EL ASISTENTE conoce y acepta que el incumplimiento de la Ley 1581 de 2012 puede generar, además de las consecuencias previstas en este acuerdo, sanciones administrativas por parte de la Superintendencia de Industria y Comercio (SIC), y responsabilidad penal conforme al artículo 269F del Código Penal colombiano (violación de datos personales).");
    ...
    bullet("", "Múltiples sesiones simultáneas con las mismas credenciales serán tratadas como actividad sospechosa.");
    subTitle("3. Límite de Sesión");
    bullet("", "Una sesión activa continua no debería superar OCHO (8) HORAS diarias. El exceso habitual será registrado como actividad anómala y generará alerta interna.");
    ...
    bullet("", "Eliminar de todos sus dispositivos personales y laborales cualquier archivo, documento, reporte, base de datos o información descargada de La Plataforma o relacionada con los clientes del Consultor Aliado.");
    bullet("", "Desinstalar cualquier aplicación o extensión utilizada para acceder a La Plataforma.");
    bullet("", "Remitir a EL PROVEEDOR y al Consultor Aliado una declaración escrita confirmando el cumplimiento de las obligaciones de eliminación y devolución de información.");
    para("El incumplimiento de esta obligación dentro del término establecido constituirá un incumplimiento grave que activará automáticamente la cláusula penal de la Cláusula Décima Segunda.");

    clauseTitle("DÉCIMA SEGUNDA", "Cláusula Penal");
    ...
    para("El pago de esta cláusula penal no extingue la obligación de reparar el daño adicional que pueda demostrarse, ni la terminación del acceso a La Plataforma, ni el cese de las actividades que la originaron. EL PROVEEDOR podrá exigir simultáneamente el cumplimiento de las obligaciones y el pago de la pena cuando esta última se hubiere estipulado por el simple retardo.");

    clauseTitle("DÉCIMA TERCERA", "Vigencia, Ley Aplicable y Jurisdicción");
    para(`El presente acuerdo tendrá vigencia a partir del ${fechaAcuerdo} y se mantendrá vigente durante todo el tiempo en que EL ASISTENTE acceda a La Plataforma. La terminación de la relación laboral o contractual entre EL ASISTENTE y el Consultor Aliado producirá automáticamente la terminación del presente acuerdo, sin perjuicio de las obligaciones que sobreviven: confidencialidad (5 años, Cláusula Cuarta) y no captación de clientes (3 años, Cláusula Quinta).`);
    para(`El presente acuerdo se regirá e interpretará conforme a las leyes de Colombia, en particular: la Ley 1581 de 2012 y Decreto 1377 de 2013 (Protección de Datos Personales), la Ley 527 de 1999 (Comercio Electrónico y Evidencia Digital), el artículo 269F del Código Penal (Violación de Datos Personales), el Código Civil y el Código de Comercio colombiano.`);
    para("Toda controversia será resuelta mediante: (1) Arreglo directo en QUINCE (15) días hábiles; (2) Conciliación ante Centro de Conciliación acreditado en Medellín, máximo TREINTA (30) días hábiles; y (3) Jueces Civiles del Circuito de Medellín, Antioquia, Colombia, a cuya jurisdicción las partes se someten expresamente.");
